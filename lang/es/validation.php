...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Las líneas siguientes contienen los mensajes de error por defecto que
    | usa la clase Validator de Laravel. Algunas reglas tienen varias
    | versiones, como las de tamaño. Podés modificar cada uno de estos
    | mensajes libremente.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado aparece en una filtración de datos conocida. Elegí uno diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Acá podés especificar mensajes personalizados para combinaciones de
    | atributo y regla. Esto permite elegir rápidamente una línea específica
    | para un atributo dado. Los mensajes puntuales del negocio (como los de
    | FormularioTurno o EditarTurno) se definen directamente en cada
    | componente Livewire, en su método messages().
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las líneas siguientes se usan para reemplazar el nombre técnico del
    | campo (en snake_case o camelCase) por uno legible en los mensajes de
    | validación, por ejemplo "hora_inicio" -> "hora de inicio".
    |
    */
    ...
    'attributes' => [
        ...
        'motivo' => 'motivo',
        'curso' => 'curso',
        'cantidad_asistentes_aproximada' => 'cantidad aproximada de asistentes',
        'notaFormal' => 'nota formal',
        'observacionesModal' => 'observaciones',
        'imagenesModal' => 'imágenes',
    ],
